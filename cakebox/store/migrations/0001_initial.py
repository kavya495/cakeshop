    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.ImageField(blank=True, null=True, upload_to='cakeimages')),
                ('shape_objects', models.ManyToManyField(to='store.shape')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cake_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='varients', to='store.cake')),
